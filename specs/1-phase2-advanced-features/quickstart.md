...
1. Press `n` → Task form opens
2. Press `Ctrl+E` → Export modal opens
3. Press `/` → Search bar focused
4. Press `?` → Shortcuts help modal opens
...
// Use React DevTools
// Install: chrome.google.com/webstore → React Developer Tools
```

...
export default function SigninPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = err.response?.data?.detail || t('auth.invalidCredentials');
      setError(message);
    } finally {
      setLoading(false);
    }
          ...
          <div className="relative">
            ...
            <div className="relative bg-card/90 backdrop-blur-xl p-6 sm:p-8 rounded-2xl border-2 border-cyan-500/30">
              ...
              <div className="text-center mb-6 sm:mb-8">
                ...
                <p className="text-muted-foreground text-xs sm:text-sm uppercase tracking-wider">{t('auth.systemAccessPortal')}</p>
              </div>
